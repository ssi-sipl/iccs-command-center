          ...
          <Card className="border-[#333] bg-[#222]">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between border-b border-[#333] pb-3">
                ...
                <span className="font-mono text-white">{sensor.sensorId}</span>
              </div>
              <div className="flex items-center justify-between border-b border-[#333] pb-3">
          ...
          <Card className="border-[#333] bg-[#222]">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-[#333] pb-3">
                ...
                <span className="text-white">{sensor.battery || "N/A"}</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <Card className="border-[#333] bg-[#222]">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-[#333] pb-3">
                ...
                <Badge
                  className={
                    sensor.sendDrone === "Yes" ? "bg-green-600" : "bg-gray-600"
                  }
                >
                  {sensor.sendDrone}
                </Badge>
